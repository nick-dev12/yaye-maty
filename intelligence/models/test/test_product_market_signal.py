...
class TestProductMarketSignal(models.Model):
    """Miroir test de ProductMarketSignal."""

    StockAlert = ProductMarketSignal.StockAlert
    ...
    def __str__(self):
        return f'[TEST] {self.product_slug} · alert={self.stock_alert or "-"}'
